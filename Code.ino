...
const char user[]  = "";
const char pass[]  = "";
const char server[] = "http://www.dickaariptian.xyz";
...
Serial.print(F("Waiting for network..."));
  ...
  Serial.println("AT+HTTPPARA=URL,http://www.dickaariptian.xyz/addDb.php?latitude=" + String(latt,10) + "&longitude=" + String(longg,10));
mySerial.println("AT+HTTPPARA=URL,http://www.dickaariptian.xyz/addDb.php?latitude=" + String(latt,10) + "&longitude=" + String(longg,10));
